...
for(let counts of countries){
  ...
  elImg.setAttribute("src", counts.img);
  elImg.setAttribute("width","267");
  elImg.setAttribute("height", "160");
  elImg.setAttribute("class", "mb-3 d-block" )
  elItem.setAttribute("class", "col-3 d-flex flex-column mb-5"); 

  elName.textContent = counts.name;
  elPop.textContent = "Population : " + counts.population;
  elRegion.textContent = "Region : " + counts.region;
  elCapital.textContent = "Capital : " + counts.capital;

  elList.appendChild(elItem);
  elItem.appendChild(elImg);
  elItem.appendChild(elName);
  elItem.appendChild(elPop);
  elItem.appendChild(elRegion);
  elItem.appendChild(elCapital);
}